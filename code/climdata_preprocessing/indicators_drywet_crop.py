...
FWD.to_netcdf(f"GGCMI-validation/data/processed/extremes_indicators/crop_specific/FWD_{crop}.nc") 
LDS.to_netcdf(f"GGCMI-validation/data/processed/extremes_indicators/crop_specific/LDS_{crop}.nc") 
LWS.to_netcdf(f"GGCMI-validation/data/processed/extremes_indicators/crop_specific/LWS_{crop}.nc")  
TPR.to_netcdf(f"GGCMI-validation/data/processed/extremes_indicators/crop_specific/TPR_{crop}.nc") 
