...
# Save the figure
ggsave(file.path(base_path, "fig2_ExtremesPerformanceMap.png"), map_extremes, width = 18, height = 12, dpi = 300)
```
...
# Save the figure
ggsave(file.path(base_path, "suppfig6_ExtremesPerformanceMap.png"), map_extremes, width = 18, height = 12, dpi = 300)
```
...
# Save the figure
ggsave(file.path(base_path, "suppfig7_ExtremesPerformanceMap.png"), map_extremes, width = 18, height = 12, dpi = 300)
```
...
# Save the figure
ggsave(file.path(base_path, "suppfig8_ExtremesPerformanceMap.png"), map_extremes, width = 18, height = 12, dpi = 300)
```
...
# Save the figure
ggsave(file.path(base_path, "suppfig9_ExtremesPerformanceMap.png"), map_extremes, width = 18, height = 12, dpi = 300)
```