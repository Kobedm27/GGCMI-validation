...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/main/fig4_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig10_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig11_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig12_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig13_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig14_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig15_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig16_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig17_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "sGGCMI-validation/results/appendix/uppfig18_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig19_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig20_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig21_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig22_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
# Save the figure 
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig23_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig24_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig25_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig26_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig27_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig28_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig29_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig30_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig31_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig32_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
...
ggsave(file.path(base_path, "GGCMI-validation/results/appendix/suppfig33_RaincloudExtremes.png"), raincloud_perc, width = 18, height = 20, dpi = 300)
```
